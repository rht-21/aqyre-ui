    ...
    <section className="docs-section">
      <article>
        ...
        <p>
          ...
          accessible React UI component library built on top of ShadCN. Whether
          you&apos;re building a new project or enhancing an existing one, Aqyre
          provides the perfect set of customizable components to help you create
          beautiful, modern web interfaces with ease.
        </p>

        <h2 id="why-aqyreui">What makes Aqyre UI special?</h2>
        <ul>
